    ...
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 sm:px-6 lg:px-8 pt-4">
      <nav
        className={cn(
          ...
          scrolled && "shadow-[0_8px_32px_-8px_rgba(0,0,0,0.12)] bg-card/85"
        )}
      >
        <div className="px-5 lg:px-7">
          <div className="flex items-center justify-between h-14 lg:h-16">
            ...
            <div className="hidden lg:flex items-center gap-7">
              ...
              <Button asChild size="sm" className="rounded-full ml-1 px-5 text-[13px] font-medium tracking-wide">
                <Link to="/kontakt">Book et kald</Link>
              </Button>
            </div>
              ...
              <div className="flex flex-col gap-5 pt-20 px-8">
                ...
                >
                  <Button asChild size="lg" className="mt-4 w-full rounded-full">
                    <Link to="/kontakt" onClick={() => setIsOpen(false)}>Book et kald</Link>
                  </Button>
                </motion.div>
              </div>
            </motion.div>
