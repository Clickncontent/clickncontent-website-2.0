...
const packages = [
  {
    ...
    price: "15.250",
    period: "1–3 måned",
    features: ["5 videoer", "Scripting", "Workshop og kreativ retning", "Content strategi"],
    highlighted: false,
  },
  {
    name: "Growth",
    price: "27.000",
    period: "1–3 måned",
    features: ["9 videoer", "Scripting", "Workshop og kreativ retning", "Content strategi", "Marketing strategi", "Løbende optimeringsanbefalinger"],
    highlighted: true,
    badge: "Mest populær",
  },
  {
    ...
    price: "39.500",
    period: "1–3 måned",
    features: ["15 videoer", "Scripting", "Workshop og kreativ retning", "Content og marketing strategi", "Løbende optimeringsanbefalinger", "Dedikeret kontaktperson og fast sparring"],
    highlighted: false,
  },
];
